...
.vue desktop
image::../images/thermo.png[height=300,width=300,role="left"]
.vue mobile
image::../images/mobile.png[height=300,width=300,role="left"]
.historique
image::../images/histo.png[height=300,width=800,role="center"]
